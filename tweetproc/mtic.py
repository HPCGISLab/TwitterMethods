...
# Modified version of TIC uses automated coding to alter user classification for concern
def mtic(infilename,time1,time2):
		...
		if not checktime(tweet,time1,time2):
		    continue
                ...
                if "actor" in tweet and "id" in tweet['actor']:
                    ...
                    if(checkrelief(tweet)):  # If it is a tweet showing relief let it count as two tweets
                        inc+=1               # This is used as an adapted method to the original TIC
